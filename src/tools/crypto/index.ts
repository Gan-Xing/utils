...
let crypto: {
  randomFillSync: (arg0: Uint8Array) => Uint8Array;
  randomBytes: (arg0: number) => {
    (): unknown;
    new (): unknown;
    toString: { (arg0: string): string; new (): unknown };
  };
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  createHash: (arg0: HashAlgorithm) => any;
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  createCipheriv: (arg0: string, arg1: CipherKey, arg2: BinaryLike) => any;
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  createDecipheriv: (arg0: string, arg1: CipherKey, arg2: BinaryLike) => any;
};
